...
- **Three Functions of a Definition:**
	1. Explain exactly what things fit in that concept.
	2. Relate concept to other concepts.
	3. Summarize all current knowledge of referents.
- **Six Rules for a Good Definition**:
...
- **Four Steps of Constructing Definitions:**
	...
	4. Write definition with genus and (important) differentia.
		- Double-check by the six rules of a good definition, esp. coextensive.

> **Tip: Indication of Missing Genus (Not Foolproof)**: When the definition begins with "when" or "where".

Aristotle: "How do we classify every thing in the world?"
- **Aristotle's Six Top-Level Categories for Existents**:
	* Thing, Actions, Relations, Quantities, Times, and Places
