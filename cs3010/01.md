...
> 
> 3. The mantissa is `01101`, so we pad the right until it's 24 bits.
> Thus, the padded mantissa is `011010000000000000000000`
> 
> 4. Altogether, this means the IEEE-754 representation $1.01101 \times 10^{11}$ in IEEE-754 is: `001101000000000000000000010000010` (sign, mantissa, exponent)
> 
> ---
>
> # II. IEEE-754 to Decimal
> 
> Q: Now, convert `0 011010000000000000000000 10000010` to a decimal.
> 
> A:
> 
...
> 
> Our number as a binary floating-point is:
> 
