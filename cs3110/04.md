...
> 
> Further, from condition 2, [y can only contain one or more a's]{.underline}.
> 
> Let's consider condition 1 when $i=0$.
> 1. $xy^iz = xz \in L$
> 2. xz has one or more a's (definition of y) removed from s, resulting in fewer a's than b's
